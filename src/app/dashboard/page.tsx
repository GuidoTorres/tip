...
export default async function DashboardPage() {
  ...
  const [{ data: profile }, { data: balances }, { data: tips }] = await Promise.all([
    supabase.from("profiles").select("public_name,username,preferred_currency").eq("id", user.id).single(),
