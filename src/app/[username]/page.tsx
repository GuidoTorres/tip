...
export async function generateMetadata({ params }: { params: Promise<{ username: string }> }): Promise<Metadata> {
  ...
  return creator ? { title: `Envía un tip a ${creator.public_name ?? creator.username}`, description: creator.bio ?? `Apoya a @${creator.username} en TipMe.` } : { title: "Creadora no encontrada" };
}
