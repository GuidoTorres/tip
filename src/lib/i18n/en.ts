export const en = {
  ...
  landing: {
    ...
    coverage: "Available across Latin America",
    coverageMore: "+ more",
    trust: "Verified payments. Clear balance. Money lands straight in your account.",
  },
  tip: {
    send: "SEND TIP",
    currencyNotice: "All tips are calculated in US dollars (USD).",
    heading: "Send a tip",
